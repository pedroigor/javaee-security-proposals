...
public class CDIAuthenticationTestCase {
    ...
    public void testAuthentication() {
        ...
        assertEquals(createPrincipal().getName(), this.securityContext.getUserPrincipal().getName());
        assertTrue(this.securityContext.getRoles().contains("Manager"));
    }

    @Test
    public void testLogout() throws ServletException {
        assertNull(this.securityContext.getUserPrincipal());
